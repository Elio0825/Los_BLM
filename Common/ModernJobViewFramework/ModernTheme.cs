...
public class ModernTheme {
  ...
  private Vector2 _savedSelectableTextAlign;
    ...
    // 圆角半径
    private float _borderRadius { get; set; } = 12f;
  ...
  private static readonly Dictionary<ThemePreset, ColorScheme> _presets = new() {
      ...
      [ThemePreset.BLM] = new ColorScheme {
          Primary = new Vector4(0.55f, 0.15f, 0.75f, 1f),
          Secondary = new Vector4(0.2f, 0.6f, 0.9f, 1f),
          Accent = new Vector4(1.0f, 0.35f, 0.2f, 1f),
          Background = new Vector4(0.08f, 0.05f, 0.12f, 0.92f),
          Surface = new Vector4(0.18f, 0.12f, 0.25f, 1f),
          Text = new Vector4(1f, 1f, 1f, 1f),
          TextSecondary = new Vector4(0.8f, 0.8f, 0.9f, 1f),
          Success = new Vector4(0.4f, 0.9f, 0.5f, 1f),
          Warning = new Vector4(1f, 0.8f, 0.2f, 1f),
          Error = new Vector4(1f, 0.4f, 0.4f, 1f),
          Border = new Vector4(0.6f, 0.4f, 0.8f, 0.4f),
          Shadow = new Vector4(0f, 0f, 0f, 0.7f),
      },
  };
